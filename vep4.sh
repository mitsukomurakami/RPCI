...
# Prepare inputs
vcfs <- list.files("$SNVDIR", "*strelka2_mutect2_muse_vardict.vcf", recursive = TRUE, full.names = TRUE)
...
runCWLBatch(vep, outdir = "$SNVDIR", inputList, paramList,
